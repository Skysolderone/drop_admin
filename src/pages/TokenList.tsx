...
const TokenList: React.FC = () => {
    ...
    const handleReloadApp = async () => {
        ...
        try {
            const { data: result } = await api.get('http://worldchain_drop_api:9393/v1/app/reload');
    ...
    const pollReloadStatus = async () => {
        ...
        const checkStatus = async () => {
            attempts++;
            try {
                const { data: result } = await api.get('http://worldchain_drop_api:9393/v1/app/reload/status');
